...
class CreateMenuTableC extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('centralizado')->create('menus', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
            $table->string('component')->nullable()->comment('componente a al que redirige el item del menú (Si es nulo es un item desplegable)');
